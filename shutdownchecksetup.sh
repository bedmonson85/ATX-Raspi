...
#This is GPIO 29 (P5-4 on the pinout diagram).
...
#This loop continuously checks if the shutdown button was pressed on ATXRaspi (GPI28 to become HIGH), and issues a shutdown when that happens.
